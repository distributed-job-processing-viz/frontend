 ...
 * Full-width on mobile with overlay, fixed sidebar on desktop
...
export function UnifiedSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className="fixed right-0 top-0 h-screen w-full sm:w-96 bg-background border-l shadow-lg z-50 flex flex-col">
